        ...
        <>
            <button
                ...
                className={variant === 'icon'
                    ? "p-1.5 md:p-2 text-gray-600 hover:text-gray-700 hover:bg-gray-50 rounded-full transition-colors"
                    : "px-4 py-2 bg-blue-600 text-white rounded-lg hover:bg-blue-700 transition-colors flex items-center gap-2"
                }
                title="Share Vehicle"
            >
                <Share2 className={variant === 'icon' ? "w-4 h-4 md:w-5 md:h-5" : "w-4 h-4"} />
