...
const CreateCustomerModal = ({ onClose }) => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            showNotification('success', 'Success', 'Customer created successfully');
            setTimeout(() => {
                onClose();
            }, 1000);
        } catch (error) {
            showNotification('error', 'Error', error || 'Failed to create customer');
        }
    };
                    ...
                    <form onSubmit={handleSubmit} className="px-6 py-6">
                        ...
                        <div className="flex items-center justify-end space-x-3 mt-6 pt-6 border-t border-gray-200">
                            ...
                            >
                                ...
                                <span>{updating ? 'Creating...' : 'Create Customer'}</span>
                            </button>
                        </div>
                    </form>
                </div>
