...
import { X, Ship, Calendar, MapPin, User, Clock, ArrowRight, Package } from 'lucide-react';
                    ...
                    {loading ? (
                        <div className="flex items-center justify-center py-12">
                            <div className="text-center">
                                ...
                                <p className="text-gray-600 mt-4">Loading shipping history...</p>
                            </div>
                        </div>
                    ) : error ? (
                        ...
                        <div className="text-center py-12">
                            ...
                            <h3 className="text-lg font-medium text-gray-900 mb-2">No shipping history</h3>
                                                ...
                                                {entry.vessel_name && (
                                                    <div className="flex items-start space-x-2">
                                                        ...
                                                        <div>
                                                            ...
                                                            <p className="text-sm font-medium text-gray-900">{entry.vessel_name}</p>
                                                        </div>
                                                    </div>
                                                )}
                                                {entry.departure_harbour && (
                                                    <div className="flex items-start space-x-2">
                                                        ...
                                                        <div>
                                                            ...
                                                            <p className="text-sm font-medium text-gray-900">{entry.departure_harbour}</p>
                                                        </div>
                                                    </div>
                                                )}
                                            </div>
                                                ...
                                                {entry.shipment_date && (
                                                    <div className="flex items-start space-x-2">
                                                        ...
                                                        <div>
                                                            ...
                                                            <p className="text-sm text-gray-900">{formatDate(entry.shipment_date)}</p>
                                                        </div>
                                                    </div>
                                                )}
                                                {entry.arrival_date && (
                                                    <div className="flex items-start space-x-2">
                                                        ...
                                                        <div>
                                                            ...
                                                            <p className="text-sm text-gray-900">{formatDate(entry.arrival_date)}</p>
                                                        </div>
                                                    </div>
                                                )}
                                                {entry.clearing_date && (
                                                    <div className="flex items-start space-x-2">
                                                        ...
                                                        <div>
                                                            ...
                                                            <p className="text-sm text-gray-900">{formatDate(entry.clearing_date)}</p>
                                                        </div>
                                                    </div>
                                                )}
                                            </div>
